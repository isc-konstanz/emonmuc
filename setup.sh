...
install_emoncms() {
  ...
  sudo -u $EMONCMS_USER git clone -b $GIT_BRANCH $GIT_SERVER/emoncms-device.git $EMONCMS_DIR/Modules/device
  sudo -u $EMONCMS_USER git clone -b $GIT_BRANCH $GIT_SERVER/emoncms-graph.git $EMONCMS_DIR/Modules/graph
  sudo -u $EMONCMS_USER git clone -b $GIT_BRANCH $GIT_SERVER/emoncms-app.git $EMONCMS_DIR/Modules/app

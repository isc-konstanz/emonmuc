...
# 3 Prepare Serial port

If your plan is to use the framework with a modbus meter, the following steps should be completed.
...
## 3.2 Raspberry Pi v3 Compatibility
